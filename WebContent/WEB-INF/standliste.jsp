  ...
  <div class="main">
    <div id="cssmenu">
      <ul>
        ...
        <li class="active" ><a href="standliste.html">Stands</a></li>
...
<div class="container">
  ...
  <div class="stand_list">
    <ul>
      ...
      <li><span><a href="stand.html?standid=${stand.standid}"><img class="standListImage" src="images/standImages/standimg4.png"/></a></span>
